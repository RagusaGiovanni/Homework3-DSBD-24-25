...
class ProxyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ForwardRequest = channel.unary_unary(
                ...
                request_serializer=proxy__pb2.ProxyUserRequest.SerializeToString,
                response_deserializer=proxy__pb2.ProxyUserResponse.FromString,
...
def add_ProxyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ForwardRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proxy__pb2.ProxyUserRequest.FromString,
                    response_serializer=proxy__pb2.ProxyUserResponse.SerializeToString,
            ),
    }
...
class ProxyService(object):
    ...
    def ForwardRequest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ProxyService/ForwardRequest',
            proxy__pb2.ProxyUserRequest.SerializeToString,
            proxy__pb2.ProxyUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
