...
class StockServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStock = channel.unary_unary(
                ...
                request_serializer=stock__pb2.StockQuery.SerializeToString,
        ...
        self.GetAverage = channel.unary_unary(
                ...
                request_serializer=stock__pb2.AverageQuery.SerializeToString,
                response_deserializer=stock__pb2.AverageResponse.FromString,
                _registered_method=True)
...
def add_StockServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetStock': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStock,
                    request_deserializer=stock__pb2.StockQuery.FromString,
                    response_serializer=stock__pb2.StockResponse.SerializeToString,
            ),
            'GetAverage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAverage,
                    request_deserializer=stock__pb2.AverageQuery.FromString,
                    response_serializer=stock__pb2.AverageResponse.SerializeToString,
            ),
    }
...
class StockService(object):
    ...
    def GetStock(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/stock.StockService/GetStock',
            stock__pb2.StockQuery.SerializeToString,
    ...
    def GetAverage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/stock.StockService/GetAverage',
            stock__pb2.AverageQuery.SerializeToString,
            stock__pb2.AverageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
